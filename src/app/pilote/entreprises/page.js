    ...
    return (
        <div className="offre-card">
            ...
            <div className="offre-actions">
                ...
                <button className="btn btn-primary" onClick={handlePostuler}>Postuler</button>
                <button className="btn btn-primary" onClick={handleEvaluer}>Évaluer</button>
            </div>
        </div>
    );
};
    ...
    return (
        <div className="offres-container">
            <div className="offres-header">
                ...
                <p>Consultez, modifiez, évaluez ou supprimez les profils d'entreprise</p>
                <input
                    type="text"
